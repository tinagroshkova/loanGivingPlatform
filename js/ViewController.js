class ViewController {
    ...
    handleHashChange = () => {
        ...
        if (hash === "home" && !userManager.loggedUser) {
            location.hash = "login";
            return;
    ...
    handleLoanSubmission = (event) => {
        ...
        if (userManager.loggedUser.isAdmin === false) {
            ...
            }, 2000); // narochno taimerut ne e 60 sekundi, za da ne se 4aka pri razcukvane
    ...
    renderLoansTableBody = () => {
        ...
        if (loansStatistics) {
            ...
            loansStatistics.acceptedLoans.forEach(loan => {
                if (loan.selectedOffer.lender === "Lender 1") {
                    lender1++;
                } else if (loan.selectedOffer.lender === "Lender 2") {
                    lender2++;
                } else if (loan.selectedOffer.lender === "Lender 3") {
                    lender3++;
                }
            });
            ...
            tableBody.innerHTML = `
                                    <tbody>
                                        ...
                                        <tr><td>Number of loan applications for each lender</td><td>Lender 1: ${lender1} offers, Lender 2: ${lender2} offers, Lender 3: ${lender3} offers</td></tr>
