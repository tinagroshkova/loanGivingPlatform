...
//     addLoan(loan) {
//         this.loans = this.loadLoans(this.username); // Parse existing loans
//         this.loans.push(loan);
//         localStorage.setItem(this.username, JSON.stringify(this.loans));
//     }
//     // addLoan(loan) {
...
//       if (loggedUser) {
//         if (loggedUser.isAdmin) {
//           this.loggedUser = new Admin(loggedUser.username, loggedUser.pass, loggedUser.isAdmin);
//         } else {
//           this.loggedUser = new User(
//             loggedUser.username,
//             loggedUser.pass,
...
//           new User("slavi", "bahur", false, []),
//           new User("bahur", "slavi", false, []),
//           new Admin("tina", "T12345*", true),
//         ];
//         localStorage.setItem("allUsers", JSON.stringify(this.users)); // Store the updated array in localStorage
//       }
...
//     loadLoans = (username) => {
//         let loans = JSON.parse(localStorage.getItem(username)) || [];
//         return loans.map(loan => new Loan(loan.id, loan.name, loan.montlyIncome, loan.desiredAmount, loan.desiredTerm));
//     }
// }
